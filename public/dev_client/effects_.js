...
function addEffect(data) {
    ...
    for(let i = 0; i < data.damage_types.length; i++) {
        ...
        // Going to need our effect to move towards the thing!
            ...
            scene_game.physics.moveTo(effect_sprites[effect_sprite_index], data.x, data.y, 50);
                ...
                if(remove_effect) {
                    ...
                    */
                    ...
                    if(effect_sprites[i].texture.key === 'electric-ball-effect') {
                        addEffect({ 'x': effect_sprites[i].destination_x, 'y': effect_sprites[i].destination_y, 'damage_types': ['electric']});
                    } 
